...
class CustomReorderableListView extends StatefulWidget {
  ...
  /// Widgets to show before or after the list
  /// If null, and empty container will be created in place.
  ...
  /// Drop area spacing controls the amount of empty space from the
  /// last list item and will take the place of the defaultDropAreaExtent
    ...
    _listOverlayEntry = OverlayEntry(
      ...
      builder: (BuildContext context) {
        return _ReorderableListContent(
          ...
          dropAreaSpacing: widget.dropAreaSpacing,
          beforeWidget: widget.beforeWidget,
          afterWidget: widget.afterWidget,
    ...
    return LayoutBuilder(builder: (BuildContext context, BoxConstraints constraints) {
      ...
      switch (widget.scrollDirection) {
        case Axis.horizontal:
          finalDropArea = SizedBox(
            key: endWidgetKey,
            width: widget.dropAreaSpacing, // _defaultDropAreaExtent,
        ...
        default:
          finalDropArea = SizedBox(
            key: endWidgetKey,
            height: widget.dropAreaSpacing, // _defaultDropAreaExtent,
      ...
      return SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            widget.beforeWidget != null? widget.beforeWidget : Container(),
            Card(  // This is the container for the reorderable list
            ...
            widget.afterWidget != null? widget.afterWidget : Container(),
          ],
        ),
      );
    });
